defmodule YAMMWeb.UserLiveTest do
  ...
  describe "Index" do
    ...
    test "lists all users", %{conn: conn, user: user} do
      ...
      assert html =~ user.slack_user_id
    end
    ...
    test "saves new user", %{conn: conn} do
      ...
      assert html =~ "some slack_user_id"
    end
    ...
    test "updates user in listing", %{conn: conn, user: user} do
      ...
      assert html =~ "some updated slack_user_id"
    end
